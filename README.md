...
### Getting Started
Fork / clone this repo as well as https://github.com/hlbtyne/seasonabl-server (follow instructions for server repo), Run npm install , npm start - should run on localhost:3000
